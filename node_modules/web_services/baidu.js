...
class CacheKeyWrapper
{
	...
	getItem(key){
		...
		return cache.getItem(prefix + key);
	}
	setItem(key, value){
		const {cache, prefix} = this;
...
function text2audio(tok, cuid, tex){
	return load('http://tsn.baidu.com/text2audio', {search:{
		...
		ctp: 1,
		lan: 'zh',
	}}).then(data => Buffer.isBuffer(data) ? data : Promise.reject(data));
}
...
function invoke(tokenFn, method, ...args){
	return new Promise((resolve, reject) => tokenFn((error, token) => {
...
exports.text2audio = text2audio;
exports.audio2text = audio2text;
exports.SimpleCache = SimpleCache;
exports.CacheKeyWrapper = CacheKeyWrapper;
