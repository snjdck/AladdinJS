...
func test()
{
	print(InjectionTypeValue.self);
}

public class Injector : IInjector
{
	public var parent: IInjector?
	var ruleDict: [String:[String:IInjectorType]] = [:]
	var metaRuleDict: [String:IInjectorType] = [:]
	...
	private func mapRule(_ key:AnyClass, _ rule:IInjectorType, _ id:String)
	{
		let key = "\(key)"
