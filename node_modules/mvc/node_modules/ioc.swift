...
public protocol IInjector : AnyObject
{
    ...
    func mapValueWeak<T>(_ value: T, id:String, realInjector:IInjector?)
    func mapValueWeak<T>(_ value: T, realInjector:IInjector?)
    func mapValueWeak<T>(_ value: T, id:String)
    func mapValueWeak<T>(_ value: T)
    ...
    func getInstance<T>(_ type: T.Type, _ id:String) -> T?
...
private class InjectionTypeValueWeak : IInjectorType
{
    weak var realInjector: IInjector?
...
public class Injector : IInjector
{
    ...
    public func mapValueWeak<T>(_ value: T, id:String, realInjector:IInjector?)
    {
        mapRule(T.self, InjectionTypeValueWeak(realInjector, value as AnyObject), id)
    }
    
    public func mapValueWeak<T>(_ value: T, realInjector:IInjector?)
    {
        mapValueWeak(value, id: "", realInjector: realInjector)
    }
    
    public func mapValueWeak<T>(_ value: T, id:String)
    {
        mapValueWeak(value, id: id, realInjector: self)
    }
    
    public func mapValueWeak<T>(_ value: T)
    {
        mapValueWeak(value, id: "", realInjector: self)
    }
    ...
    public func getInstance<T>(_ type: T.Type, _ id:String) -> T?
    {
