...
class Module
{
	...
	notify(msgName, msgData=null){
		...
		this.execCmd(this._commandDict[msg.name], msg);
	...
	regCommand(msgName, cmdType){
		this._commandDict[msgName] = cmdType;
	}

	regCommandAll(commands){
		Object.assign(this,_commandDict, commands);
	}

	execCmd(cmdType, msg){
		return cmdType && this._injector.inject(new cmdType()).exec(msg);
	}
