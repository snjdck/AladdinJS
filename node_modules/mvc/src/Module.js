...
class Module
{
	...
	_viewSet = new Set();
	_roleSet = new Set();
	_globalMsgInterested;
	_globalMsgDispatched;
	...
	constructor(meta, injector, application){
		...
		this.meta = meta;
		this._globalMsgInterested = new Set(meta.msgNamesInterested);
		this._globalMsgDispatched = new Set(meta.msgNamesDispatched);
	}
	...
	notify(msgName, msgData=null){
		...
		const msg = new Msg(msgName, msgData);
		...
		this._application.notifyAll(msgName, msgData, this);
