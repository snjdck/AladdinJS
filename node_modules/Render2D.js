...
const {batchDraw, DrawMode} = require("./renderers");
...
class Render2D
{
	...
	set mode(value){
		let isPickMode = value == DrawMode.Pick;
		let shader = isPickMode ? "shader2d&pick" : "shader2d&normal";
		this.isPickMode = isPickMode;
		this.program = this.gl.programMgr.fetch(shader);
	}
