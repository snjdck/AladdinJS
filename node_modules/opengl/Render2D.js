...
class Render2D
{
	constructor(){
		...
		this.worldMatrixBuffer = new UniformBuffer(2, 0, programMgr.MAX_VERTEX_UNIFORM_VECTORS);
		this.textureMulBuffer = new UniformBuffer(1, 0, programMgr.MAX_VERTEX_UNIFORM_VECTORS);
		this.textureAddBuffer = new UniformBuffer(1, 0, programMgr.MAX_VERTEX_UNIFORM_VECTORS);
		this.rectSizeBuffer = new UniformBuffer(1, 0, programMgr.MAX_VERTEX_UNIFORM_VECTORS);
		this.scale9gridBuffer = new UniformBuffer(1, 0, programMgr.MAX_VERTEX_UNIFORM_VECTORS);
		this.colorBuffer = new UniformBuffer(1, 0, programMgr.MAX_VERTEX_UNIFORM_VECTORS);
	...
	submit(){
		...
		let drawCount = batchDraw.call(this, targetList, uniformBuffer.maxInstanceCount);
	...
	onBatchBegin(){
		...
		let {profileMgr, mouseMgr} = WebGL;
		let {uniformBuffer} = this;
		uniformBuffer.setInts(2, mouseMgr.nextPickID);
	}
}
