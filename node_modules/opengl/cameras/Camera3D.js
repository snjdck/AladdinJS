...
class Camera3D extends DisplayObject3D
{
	constructor(lens){
		...
		//this.drawUnitCollector.camera = this;
		this.lens = lens;
	...
	render(root, mode){
		...
		const {rotation, translation} = this.worldTransformInvert;
		rotation.toMatrix(simd.floatView, translation);
		simd.floatView.set(this.lens, 16);
		simd.mat4_concat();
		simd.calc_planes();
