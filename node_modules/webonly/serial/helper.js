...
const regexp_checker = regexp => value_checker(v => regexp.test(v.toString()));

const prependInts = (buffer, ...ints) => Buffer.concat([ints_to_buffer(...ints), buffer]);

exports.delay = delay;
exports.ints_to_buffer = ints_to_buffer;
exports.prependInts = prependInts;
...
exports.regexp_checker = regexp_checker;
