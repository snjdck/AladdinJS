...
const {delay, ints_to_buffer, align_data, encode_c0db, checker_c0db, value_checker} = require('./helper');
...
async function write_dataframe(serial, cmd, frameSize, data, progressFn=null){
	for(let [payload, totalSize] of to_frame(data, frameSize, (v, i) => Buffer.concat([ints_to_buffer(v.length, i, 0, 0), v]))){
