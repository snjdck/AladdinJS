...
function require(path){
	path = calcPath(path);
	if(path in moduleDict)return moduleDict[path].exports;
	let request = new XMLHttpRequest();
	request.open('GET', path, false);
	request.send();
	const body = request.response;

	const module = moduleDict[path] = {exports:{}};
	pathStack.push(path);
	Function('module', 'exports', body).call(module.exports, module, module.exports);
	pathStack.pop();
