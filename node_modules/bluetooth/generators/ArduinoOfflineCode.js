...
*/
	...
	Arduino.weeemake_speech_recognition_set_keyword = function(block, {pin, value}){
		let key = `speechRec_` + pin;
		this.addInclude('#include<WeSpeechRecognition.h>')
		this.addVarDef(`WeSpeechRecognition ${key}(${pin})`, key);
...
*/
	...
	Arduino.weeemake_adapter_digitalWrite = function(block, {pin, index, value}){
		let key = `adapter_` + pin;
		this.addInclude('#include<WeAdapter.h>');
		this.addVarDef(`WeAdapter ${key}(${pin})`, key);
	...
	Arduino.weeemake_wifi_set_info = function(block, {pin, SSID='', PWD=''}){
		let key = `wifi_` + pin;
		this.addInclude('#include<WeWifi.h>');
		this.addVarDef(`WeWifi ${key}(${pin})`, key);
