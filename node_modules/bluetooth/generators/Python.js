...
class Python extends Generator {
...
Python.prototype.onGenVarDef = function(){
	const varType = {
		"Number": '0',
		"String": '""',
		"Boolean": 'False',
	...
	return (name, type) => `${name} = ${varType[type]}`;
}();

Object.assign(Python.prototype, {
	ORDER_ATOMIC: 0,
	ORDER_HIGH: 1,
	...
	ORDER_BIT_OR: 9,
	ORDER_RELATIONAL: 10,//<,<=,>,>=
	ORDER_EQUAL: 10,//==, !=, same as ORDER_RELATIONAL
	ORDER_NOT: 11,
	ORDER_AND: 12,
	ORDER_OR: 13,
	ORDER_NONE: 99,
