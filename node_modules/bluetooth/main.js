...
Blockly.defineBlocksWithJsonArray([
	{
		...
		"args0": [
			...
			{"type": "field_dropdown", "name": "IMAGE_RECOGNITION_TYPE", "options":[
				[{src:'static/color/1.png',width:30,height:12,alt:'%{BKY_COLOUR_RGB_RED}'}, '1'],
				[{src:'static/color/2.png',width:30,height:12,alt:'%{BKY_COLOUR_RGB_YELLOW}'}, '2'],
				[{src:'static/color/3.png',width:30,height:12,alt:'%{BKY_COLOUR_RGB_BLUE}'}, '3'],
				[{src:'static/color/4.png',width:30,height:12,alt:'%{BKY_COLOUR_RGB_GREEN}'}, '4'],
				[{src:'static/color/5.png',width:30,height:12,alt:'%{BKY_COLOUR_RGB_DARK_GREEN}'}, '5'],
			]}
		],
		"output": "Boolean",
		"extensions": ["colour_robots", "markAsyncFunc"]
