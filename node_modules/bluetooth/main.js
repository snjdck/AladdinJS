...
Blockly.Variables.flyoutCategory = function(){
	...
	const result = [
		`<button text="%{BKY_NEW_VARIABLE} Number" callbackKey="CREATE_VARIABLE_NUMBER"></button>`,
		`<button text="%{BKY_NEW_VARIABLE} String" callbackKey="CREATE_VARIABLE_STRING"></button>`,
		`<button text="%{BKY_NEW_VARIABLE} Boolean" callbackKey="CREATE_VARIABLE_BOOLEAN"></button>`,
		`<button text="%{BKY_NEW_VARIABLE} Array" callbackKey="CREATE_VARIABLE_ARRAY"></button>`,
	];
