...
Blockly.defineBlocksWithJsonArray([{
		...
		"type": "stage_turn_left",
		"message0": "左转",
		"style": "logic_blocks",
		"extensions": ["markStatement", "markAsyncFunc"]
	},{
		"type": "stage_turn_right",
		"message0": "右转",
		"style": "logic_blocks",
		"extensions": ["markStatement", "markAsyncFunc"]
	},{
...
result.stage_drag = function(){
	window.mygame_drag();
}

result.stage_drop = function(){
	window.mygame_drop();
}

result.stage_move = function({X, Y}){
	return window.mygame_goto(X, Y)
}

result.stage_move_forward = function({VALUE}){
	return window.mygame_move_forward(VALUE);
}

result.stage_move_backward = function({VALUE}){
	return window.mygame_move_backward(VALUE);
}

result.stage_turn_left = function(){
	return window.mygame_turn_left();
}

result.stage_turn_right = function(){
	return window.mygame_turn_right();
}
...
const createElement = require('../vdom/createElement').createElement(React.createElement);
...
ReactDOM.render(MainFrame(), mainFrame);
