...
Blockly.Extensions.registerMutator('procedures_definition', {
	...
	_onUpdateShape(funcName, argList, argInputList, hasOutput){
		this._forEachCallDo(block => block._updateShape(funcName, argList, hasOutput));
	...
	addArg(name){
		const input = this.appendValueInput(name).setCheck('procedures_param');
		this.moveInputBefore(name, 'PARAMS');
	...
	syncCallBlocks(){
		...
		const argList = this._getArgList();
