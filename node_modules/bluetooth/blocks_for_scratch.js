...
module.exports = board => [
	{
		...
		"message0": "%1",
		"args0": [
			{"type": "field_dropdown", "name": "VALUE", "options":options[board].sensor_port}
		],
		"output": "SENSOR_PORT",
		"style": "other_blocks"
	},{
		...
		"message0": "%1",
		"args0": [
			{"type": "field_dropdown", "name": "VALUE", "options":options[board].board_port}
		],
		"output": "BOARD_PORT",
		"style": "other_blocks"
	},{
		...
		"message0": "M %1",
		"args0": [
			{"type": "field_dropdown", "name": "VALUE", "options":options[board].dc_motor_index}
		],
		"output": "Number",
		"style": "other_blocks",
		...
		"args0": [{"type": "field_variable", "name": "LIST", "variable": "%{BKY_MATH_CHANGE_TITLE_ITEM}"}],
		"output": "Number",
		"style": "list_blocks",
