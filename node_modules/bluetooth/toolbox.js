{
	...
	"contents": [
		...
		{
			"name": "%{BKY_CATEGORY_LIGHT_SOUND}",
			"categorystyle": "sound_light_category",
			"kind": "category",
			"contents": [
				{
		...
		},
		{
			...
			"contents": [
				...
				},
				{
					...
					"kind": "block",
					"inputs": {
						"ULTRASONIC_LED_INDEX": {"shadow": {"type": "led_index"}},
				...
				},
				{
					...
					"inputs": {
						"ULTRASONIC_LED_INDEX": {"shadow": {"type": "led_index"}},
						"ON_OFF": {"shadow": {"type": "logic_boolean"}}
					}
				},
				{
