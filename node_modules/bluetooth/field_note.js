...
Blockly.utils.object.inherits(Blockly.FieldNote, Blockly.FieldTextInput);
 ...
 * @const
 */
Blockly.FieldNote.MAX_NOTE = NOTE_LIST.length - 1;
...
Blockly.FieldNote.prototype.changeOctaveBy_ = function(octaves) {
  ...
  var newNote = NOTE_LIST.indexOf(Number(this.getText())) + (octaves * 12);
...
Blockly.FieldNote.prototype.updateSelection_ = function() {
  var noteNum = NOTE_LIST.indexOf(Number(this.getText()));
...
Blockly.fieldRegistry.register('field_note', Blockly.FieldNote);
