...
class SyntaxTreeFactory
{
	...
	static Call(method, argList, retCount){
		return this.NewInvoke(this.GetVar(method), argList, retCount);
	}
	
	static NewExpression(name, argList){
		return this.Call(name, argList, 1);
	}
	
	static NewStatement(name, argList){
		return this.Call(name, argList, 0);
	}
...
export default SyntaxTreeFactory;