...
class BlockBase
{
	...
	onMouseDown(e){
		...
		block.notifyEvt("block_drag_begin");
		...
		window.addEventListener("mouseup", function(){
			...
			indicator.clear();
			let deleteFlag = !block.notifyEvt("block_drag_end");
			if(deleteFlag)return;
			block.bg.removeChild(blockDragAni);
			if(dropTarget != null){
				dropTarget.insert(block);
			}
			block.notifyEvt("block_changed");
		}, {once:true});
	}
