...
class Interpreter
{
	...
	compile(blockList){
		return this.optimize(castJsonCodeToAssembly(blockList));
	}
...
const castJsonCodeToAssembly = require('./JsonCodeToAssembly');
const optimizeAssembly = require('./AssemblyOptimizer');
const cleanDeadCode = require('./DeadCodeCleaner');
const printCodeList = require('./CodeListPrinter');
