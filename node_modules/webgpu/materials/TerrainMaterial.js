...
const bindGroupCache = createWeakMapGetter(function(texture){
	return this.createBindGroup(1, [{binding:0, resource:texture.createView({dimension: '2d-array'})}]);
});
...
class TerrainMaterial extends Material.Subclass(
	...
	static *calcDrawIterator(entityList, mesh){
		for(const [texture, subEntityList] of classifyTexture(entityList)){
			Vulkan.renderPassEncoder.setBindGroup(1, bindGroupCache.call(this, texture));
