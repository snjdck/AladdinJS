...
const pickPipeline = new Pipeline({
	groups: [[{name:'vpMatrix', type:'MVP', buffer:{}}], [{name:'heightTexture', texture:{}}]],
	vertex: {
		buffers: [{name: 'meshId', stepMode: 'instance', attributes: [{format:'uint32'}], temp:{type:Uint32Array, mapFn: v => [v.entity.pickID]}}],
		code: `
			const height_scale: f32 = 0;//400.0
			const tileSize: f32 = 100;
			const vertexCount: u32 = 256;
