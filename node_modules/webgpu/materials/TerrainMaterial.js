...
const pipeline = {
	groups: [TextureMaterial.pipelineDesc.groups[0], [
		TextureMaterial.pipelineDesc.groups[1][0],
		{name:'baseTexture', binding:1, visibility:GPUShaderStage.FRAGMENT, texture:{viewDimension: '2d-array'}}
	]],
	vertex: {
		buffers: [{
			name: 'layer0',
	...
	fragment: {
		targets:TextureMaterial.pipelineDesc.fragment.targets_deferred,
		entryPoint: 'main',
		code: `
