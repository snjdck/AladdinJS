...
fn getBoneMatrix(boneStateTexture:texture_2d_array<f32>, boneIndex:u32, instanceIndex:u32) -> mat3x4<f32> {
	let coords = vec2(boneIndex, instanceIndex);
	return cast2mat3x4(
		textureLoad(boneStateTexture, coords, 0, 0),
		textureLoad(boneStateTexture, coords, 1, 0)
	);
}
`
/*
