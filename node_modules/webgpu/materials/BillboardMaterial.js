...
const pipeline = {
	...
	vertex: {
		buffers: [{
			...
			valueArray: new Float32Array(12 * maxCountPerDraw),
			valueStride: 12,
		}],
		entryPoint: 'main',
		code: `
...
const mapFn = drawUnit => drawUnit.entity.worldTransform.rawData;

class BillboardMaterial extends Material.Subclass({pipeline}, [Material.Utils.groupTexture, Material.Utils.cut(maxCountPerDraw)]){
