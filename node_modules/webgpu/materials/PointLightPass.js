	...
	fragment: {
		...
		code: `
			...
			fn main(
				...
				let a = light[0].screenMatrix[2][2];
				let b = light[0].screenMatrix[2][3];

				let t = (a + b / length(cameraPosition));

				//depth_ref <= the sampled depth
				let depth_value = textureSampleCompare(texture_depth, sampler_depth, -lightDir, t - 0.001);
				...
				return vec4<f32>(vec3<f32>(1 - lightPower / lightRange) * factor * depth_value, 1);
			}
		`
	},
	primitive: {
