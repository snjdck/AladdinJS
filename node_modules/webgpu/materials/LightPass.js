...
const pipeline = new Pipeline({
	groups: [[
		...
		{binding:4, visibility:GPUShaderStage.FRAGMENT, sampler:{type:'non-filtering'}, default:{}},
		{binding:5, visibility:GPUShaderStage.FRAGMENT, texture:{sampleType:'depth'}},
		{binding:6, visibility:GPUShaderStage.FRAGMENT, buffer:{}},
		{binding:7, visibility:GPUShaderStage.FRAGMENT, sampler:{type:'comparison'}, default:{compare:'greater'}},
	]],
	vertex: {
		buffers: [{
			arrayStride: 2 << 2,
	...
	fragment: {
		...
		struct MVP {
			...
			@group(0) @binding(5) var texture_depth: texture_depth_2d;
			...
			fn main(
				...
				var depth_value = textureSampleCompare(texture_depth, sampler_depth, depth_uv, screenPosition.z / screenPosition.w);
				let is_in_shadow = depth_value > 0;
