...
const pipeline = TextureMaterial.pipeline.clone({
	...
	fragment:{
		...
		code: `
			...
			@fragment
			fn main() -> OutputDeferred {
				return OutputDeferred(textureSample(baseTexture, g_sampler, uv), vec4<f32>(normalize(world_normal),0), textureSample(baseTexture, g_sampler, uv));
			}
		`
	}
});
