...
class Material{
	...
	static bindGroupSlots = [];
	static Subclass(pipelineDesc, bindGroupSlotsFn){
		const Sub = class extends this {};
		Object.defineProperty(Sub, 'pipeline', {get: Vulkan.createRenderPipelineGetter(pipelineDesc)});
		if(bindGroupSlotsFn){
			Object.defineProperty(Sub, 'bindGroupSlots', {get: delayNew(bindGroupSlotsFn)});
		}
		return Sub;
	}
