...
class Material{
	...
	static Subclass(pipelineFn, bindGroupSlotsFn){
		const Sub = class extends Material {};
		Object.defineProperty(Sub, 'pipeline', {get: pipelineFn});
		const descriptor = bindGroupSlotsFn ? {get: delayNew(bindGroupSlotsFn)} : {value: []};
		Object.defineProperty(Sub, 'bindGroupSlots', descriptor);
		return Sub;
	}
