...
const pipeline = new Pipeline({
	groups: [[
		{name:'baseTexture', binding:0, visibility:GPUShaderStage.FRAGMENT, texture:{sampleType:'float'}},
		{name:'lightTexture', binding:1, visibility:GPUShaderStage.FRAGMENT, texture:{sampleType:'float'}},
