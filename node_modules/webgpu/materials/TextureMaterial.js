	...
	fragment: {
		...
		code: `
			...
			fn main(@location(0) uv: vec2<f32>) -> @location(0) vec4<f32> {
				let color = textureSample(g_texture, g_sampler, uv);
			...
			fn mainDeferred(
				...
				return OutputDeferred(textureSample(g_texture, g_sampler, uv), vec4<f32>(normalize(normal),0), textureSample(g_texture, g_sampler, uv));
			}
		`
	},
	depthStencil: {
