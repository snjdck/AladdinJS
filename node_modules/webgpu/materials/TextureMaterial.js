...
const pipeline = new Pipeline({
	groups: [[
		...
		{name:'worldMatrixList', type:`array<mat3x4<f32>, ${maxCountPerDrawStatic}>`, buffer:{}, temp:{array: new Float32Array(12 * maxCountPerDrawStatic), stride: 12, mapFn: v => v.entity.worldTransform.rawData}},
		{name:'animationTexture', texture:{viewDimension: '2d-array', sampleType:'unfilterable-float'}},
		{name:'animationTextureInfo', type:`array<vec4<f32>, ${maxCountPerDrawStatic}>`, buffer:{}, temp:{array: new Float32Array(4 * maxCountPerDrawStatic), stride: 4, mapFn: v => [v.animationTime ?? 0, v.animationIndex ?? 0]}},
	], [
...
const wireframePipeline = pipeline.clone({
	...
	buffers: v => [v[0], v[3]],
	vertex:{code:`#include<vertexPosition>`},
