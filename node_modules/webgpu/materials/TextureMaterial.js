...
const wireframePipeline = pipeline.clone({
	groups: v => [[{name:'vpMatrix', type:'MVP', buffer:{}},{name:'g_sampler', visibility:GPUShaderStage.FRAGMENT, sampler:{}, default:{}}], [worldMatrixList(), animationTexture(), animationTextureInfo()]],
	buffers: v => [v[0], v[3]],
...
const depthPipeline = pipeline.clone({
	groups: v => [[{name:'vpMatrix', type:'MVP', buffer:{}}], [worldMatrixList(), animationTexture(), animationTextureInfo()]],
	buffers: v => [v[0], v[3]],
	vertex:{code:`#include<vertexPosition>`},
	fragment:null,
