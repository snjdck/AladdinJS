...
const pipeline = new Pipeline({
	groups: [[
		{name:'vpMatrix', type:'MVP', binding:0, visibility:GPUShaderStage.VERTEX, buffer:{}},
		{name:'g_sampler', binding:1, visibility:GPUShaderStage.FRAGMENT, sampler:{}, default:{magFilter:'linear', minFilter:'linear', addressModeU:'repeat', addressModeV:'repeat', addressModeW:'repeat'}}
	], [
		{name:'worldMatrixList', type:`array<mat3x4<f32>, ${maxCountPerDrawStatic}>`, binding:0, visibility:GPUShaderStage.VERTEX, buffer:{}, temp:{array: new Float32Array(12 * maxCountPerDrawStatic), stride: 12, mapFn: v => v.entity.worldTransform.rawData}},
		...
		{name:'animationTextureInfo', type:`array<vec4<f32>, ${maxCountPerDrawStatic}>`,binding:3, visibility:GPUShaderStage.VERTEX, buffer:{}, temp:{array: new Float32Array(4 * maxCountPerDrawStatic), stride: 4, mapFn: v => [v.animationTime ?? 0, v.animationIndex ?? 0]}},
	], [
