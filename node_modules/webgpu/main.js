...
const {loadImage} = require('webonly/utils');
...
async function init(){
	...
	*/
	...
	const meshTerrain = view3d.scene3d.root.addChild(new MeshEntity(terrainMesh).addMaterial(new TerrainMaterial(terrainTexture.createView({dimension: '2d-array'}))));
