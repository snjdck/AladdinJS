...
const Bitmap3DCollector = require('./predrawers/Bitmap3DCollector');
const Filter2DCollector = require('./predrawers/Filter2DCollector');
...
async function init(){
	...
	view3d.registerPreDrawer(Bitmap3DCollector());
	view3d.registerPreDrawer(Filter2DCollector());

	view3d.scene3d.camera = new Camera3D(Lens.OrthoLH(canvas.width, canvas.height, -5000, 5000));
	...
	monsterMesh.addMaterial(new TextureMaterial()).addMaterial(new BoundMaterial());
