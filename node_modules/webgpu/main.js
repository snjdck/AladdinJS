...
async function init(){
	...
	*/
	...
	const encoder = new EncoderEx(device, canvas);
	...
	let mirrorMesh = Vulkan.addMeshBufferGetter(createPlane());
...
//*/	
	...
	const texture = await encoder.loadTexture('./1.png')
	const texture2 = await encoder.loadTexture('./2.jpg')
		...
		void async function(){
			const menu01 = await encoder.loadTexture('assets/Interface/menu01_new.jpg');
			const menu02 = await encoder.loadTexture('assets/Interface/Menu02.jpg');
			const menu03 = await encoder.loadTexture('assets/Interface/Menu03_new.jpg');
			const Menu_Red = await encoder.loadTexture('assets/Interface/Menu_Red.jpg');
			const Menu_Blue = await encoder.loadTexture('assets/Interface/Menu_Blue.jpg');
			const Menu_Character = await encoder.loadTexture('assets/Interface/Menu_Character.jpg');
			const Menu_Inventory = await encoder.loadTexture('assets/Interface/Menu_Inventory.jpg');
			const Item_Back01 = await encoder.loadTexture('assets/Interface/Item_Back01.jpg');
			const Item_Back02 = await encoder.loadTexture('assets/Interface/Item_Back02.jpg');
			const Level_box = await encoder.loadTexture('assets/Interface/Level_box.jpg');
			const level_01 = await encoder.loadTexture('assets/Interface/level_01.jpg');

			const Item_Fairy = await encoder.loadTexture('assets/Interface/Item_Fairy.jpg');
			const Item_Cap = await encoder.loadTexture('assets/Interface/Item_Cap.jpg');
			const Item_Wing = await encoder.loadTexture('assets/Interface/Item_Wing.jpg');
			const Item_Weapon01 = await encoder.loadTexture('assets/Interface/Item_Weapon01.jpg');
			const Item_NeckLace = await encoder.loadTexture('assets/Interface/Item_NeckLace.jpg');
			const Item_Upper = await encoder.loadTexture('assets/Interface/Item_Upper.jpg');
			const Item_Weapon02 = await encoder.loadTexture('assets/Interface/Item_Weapon02.jpg');
			const Item_Gloves = await encoder.loadTexture('assets/Interface/Item_Gloves.jpg');
			const Item_Ring = await encoder.loadTexture('assets/Interface/Item_Ring.jpg');
			const Item_Lower = await encoder.loadTexture('assets/Interface/Item_Lower.jpg');
			const Item_Boots = await encoder.loadTexture('assets/Interface/Item_Boots.jpg');
			const Item_box = await encoder.loadTexture('assets/Interface/Item_box.jpg');
			const Item_Money = await encoder.loadTexture('assets/Interface/Item_Money.jpg');
			const exit_01 = await encoder.loadTexture('assets/Interface/exit_01.jpg');
			const exit_02 = await encoder.loadTexture('assets/Interface/exit_02.jpg');
			const repair_01 = await encoder.loadTexture('assets/Interface/repair_01.jpg');
