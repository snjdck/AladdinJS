...
const {vertexCode: vertexShaderGLSL, fragmentCode: fragmentShaderGLSL} = require('./shaders/2d');
const {vertexCode: vertex3DShaderGLSL, fragmentCode: fragment3DShaderGLSL} = require('./shaders/3d');
const {vertexCode: filterVertexShaderGLSL, fragmentCode: filterFragmentShaderGLSL} = require('./shaders/filter');
