...
async function init(){
	...
	mesh1.matrix.appendRotation(rot).moveTo(0, -100, 0);
	mesh2.matrix.appendRotation(rot).moveTo(0, 0, 0);
	mesh3.matrix.appendRotation(rot).moveTo(0, 100, 0);
	monsterMesh.matrix.appendRotation(rot).moveTo(-100, -100, 0);
	...
	for(let mesh of meshList){
		...
		//playerEntity.addChild();
		meshEntity.matrix.appendRotation(rot);
	}
	playerEntity.matrix.appendRotation(rot);
