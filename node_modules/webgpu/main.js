...
const filterFragmentShaderGLSL = `#version 450
	...
	void main() {
		...
		outColor = sum * vec4(1, 0, 1, 1);
	}
`;

const colormatrixFragmentShaderGLSL = `#version 450
	...
	void main() {
		vec4 temp = texture(sampler2D(_texture, _sampler), uv);
		outColor = temp * vec4(0, 1, 1, 1);
	}
`;
...
async function init(){
	...
	Vulkan.colormatrixFragmentCode = glslang.compileGLSL(colormatrixFragmentShaderGLSL, "fragment");
