...
const drawFilter2D = (item, camera) => {
	...
	Vulkan.commandEncoders1.unshift(commandEncoder);
	...
	if(item.filter.justCopyFlag){
		...
		commandEncoder.copyTextureToTexture(
			{texture, origin: [clipRect.x - areaRect.x, clipRect.y - areaRect.y, 0]},
