...
const ViewportManager = require('../managers/ViewportManager');
/*
...
Vulkan.registerManagerFactory('viewportMgr', ViewportManager);

const {VertexBufferSlot, UniformBufferSlot} = require('../helper/Slot');

Vulkan.registerMaterialSlot('transform', UniformBufferSlot(GPUShaderStage.VERTEX, 256, function(){
...
Vulkan.registerMaterialSlot('color', UniformBufferSlot(GPUShaderStage.FRAGMENT, 256, ({material}) => new Float32Array(material.color)));

Vulkan.registerMaterialSlot('bound', UniformBufferSlot(GPUShaderStage.VERTEX, 256, function(){
...
Vulkan.registerMaterialSlot('bone', UniformBufferSlot(GPUShaderStage.VERTEX, 4096, function(){
