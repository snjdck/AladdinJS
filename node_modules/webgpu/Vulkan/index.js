...
Vulkan.registerMaterialSlot('transform', UniformBufferSlot(256, function(){
...
Vulkan.registerMaterialSlot('color', UniformBufferSlot(256, ({material}) => new Float32Array(material.color)));

Vulkan.registerMaterialSlot('bound', UniformBufferSlot(256, function(){
...
Vulkan.registerMaterialSlot('bone', UniformBufferSlot(4096, function(){
