...
Vulkan.registerMaterialSlot('transform', UniformBufferSlot('2_dynamic', 256, function(){
...
Vulkan.registerMaterialSlot('color', UniformBufferSlot('4', 256, ({material}) => new Float32Array(material.color)));

Vulkan.registerMaterialSlot('bound', UniformBufferSlot('2_dynamic', 256, function(){
...
Vulkan.registerMaterialSlot('bone', UniformBufferSlot('2_dynamic', 4096, function(){
