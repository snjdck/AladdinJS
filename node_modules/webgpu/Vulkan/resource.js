...
const fetchTextures = TexturePool((width, height) => {
	...
	const normalTexture = device.createTexture({format: 'rgba32float', size, usage});
	...
	return {
		colorTexture, positionTexture, normalTexture, depthTexture, lightTexture,
...
const fetchViewForDepth = TexturePool((width, height) => {
	...
	//const colorTexture = Vulkan.device.createTexture({format: 'bgra8unorm', size, usage});
