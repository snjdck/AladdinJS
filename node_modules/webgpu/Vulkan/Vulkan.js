...
Vulkan.bindComputePipeline = function(target, descriptor, name='pipeline'){
	this.defineProperty.call(target, name, () => this.createComputePipeline(descriptor));
}
...
Vulkan.bindRenderPipeline = function(target, descriptor, name='pipeline'){
	this.defineProperty.call(target, name, () => this.createRenderPipeline(descriptor));
}
...
Vulkan.createBindGroup = function(name, resourceList){
	...
	return this.device.createBindGroup({layout: this[`layout_${name}`], entries});
}
