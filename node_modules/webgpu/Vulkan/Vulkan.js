...
const {createDepthTexture, setViewport} = require('webonly/utils_gpu');
...
Vulkan.createDepthTexture = (width, height) => createDepthTexture(Vulkan.device, width, height);
Vulkan.now = () => performance.now();
Vulkan.setViewport = (rect, minDepth=0, maxDepth=1) => setViewport(Vulkan.renderPassEncoder, rect, minDepth, maxDepth);
