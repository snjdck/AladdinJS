...
Vulkan.onInit = function(){
	for(const [name, factory] of Object.entries(this._managerFactoryDict)){
		this.registerManager(name, new factory());
	}
}
...
Vulkan.createUniformBufferListCache = function(layout, size=0x4000){
	const bufferList = [];
	const bindGroupList = [];
