...
const filterVertexShaderGLSL = `
	...
	[[stage(vertex)]]
	fn main() -> void {
		var vertexXY: vec2<f32> = vec2<f32>(vec2<i32>(gl_VertexIndex >> 1u, gl_VertexIndex & 1));
...
const filterFragmentShaderGLSL = `
	...
	[[binding(0), set(0)]] var _sampler: sampler;
	[[binding(1), set(0)]] var _texture: texture_2d<f32>;
