...
const fragmentShaderGLSL = `
	...
	[[binding(0), set(1)]] var<uniform_constant> _texture: texture_sampled_2d_array<f32>;
	...
	fn main() -> void {
		outColor = mix(
			textureSample(_texture, _sampler, vec3<f32>(uv, layer.x)),
			textureSample(_texture, _sampler, vec3<f32>(uv, layer.y)),
			layer.zzzz
		) * light;
		return;
	}
