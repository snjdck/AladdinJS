...
class Matrix3D{
	...
	append(other, result=this){
		return Matrix3D.concat(this, other, result);
	}
	
	prepend(other, result=this){
		return Matrix3D.concat(other, this, result);
	}
	...
	copyToArray(list, offset=0){
		...
		//list[offset+7] = this.parentBoneOffset;
	}
	...
	setFromMatrixRawData(rawData){
		let {rotation, translation} = this;
		rotation.fromMatrix(rawData);
		translation.setTo(rawData[3], rawData[7], rawData[11]);
		return this;
	}
