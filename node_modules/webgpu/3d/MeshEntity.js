...
class MeshEntity extends DisplayObject3D
{
	...
	addMaterial(material, subMeshFilter=0xFFFFFFFF){
		//how about material.subMeshFilter?
		this.materialDict.set(material, subMeshFilter);
		return this;
	}

	removeMaterial(material){
		this.materialDict.delete(material);
	}

	getMaterials(){
		return this.materialDict.entries();
	}

	*onCollectEntities(camera){
		if(this.materialDict.size > 0)yield this;
