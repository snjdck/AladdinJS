...
class DirectionLight3D extends Light3D
{
	...
	drawDeferred(commandEncoder, ctx){
	...
	drawDepthMap(commandEncoder, shadowCasterList, viewCamera){
		...
		const depthView = commandEncoder.fetchTextureView(depthTexture, '2d,depth-only,0,1');
		const depthStencilView = commandEncoder.fetchTextureView(depthTexture, '2d,all,0,1');
