...
*/
	...
	drawDepthMap(shadowCasterList, ctx, tempBuffer){
		...
		const {colorView, depthView, depthStencilView} = fetchViewForDepth({width, height});
		this.depthView = depthView;
		this.tempBuffer =tempBuffer

		for(let commandEncoder of CommandEncoder(Vulkan.device)){
			for(let renderPassEncoder of clearDepthPass(commandEncoder, colorView, depthStencilView)){
				renderPassEncoder.setViewport(0, 0, width, height, 0, 1);
