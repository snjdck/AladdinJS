	...
	static Draw = function(){
		...
		return function(entityList){
			...
			for(const [mesh, entityList] of meshDict){
				...
				const subMeshList = mesh.subMeshList.map(subMesh => {
				...
				for(let i=0; i<drawCount; ++i){
					...
					renderPassEncoder.setBindGroup(1, device.createBindGroup({
					...
					subMeshList.filter(Boolean).forEach(({vertexCount, vertexOffset, bindGroup}) => {
