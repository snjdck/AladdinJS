...
class DirectBufferManager
{
	...
	draw(subMesh, vertexCount, instanceCount, baseVertex, baseInstance){
		...
		for(let i=0; i<instanceCount; ++i){
			boundBuffer.setSubData((this.totalIndex + i) * 32, new Float32Array([
				500,500,500,0,
				-500,-500,-500,0
			]));
			buffer.setSubData(offset, new Uint32Array([vertexCount, 0, baseVertex, baseInstance+i]));
...
*/
	...
	setDispatchValue(){
		this.dispatchBuffer.setSubData(0, new Uint32Array([this.totalIndex, 1, 1]));
	}
}
