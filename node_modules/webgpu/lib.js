...
class Scene3D
{
	...
	draw(){
		...
		textureBindGroupDesc.bindings[0].resource.buffer = window.testUniformBuffer;
		...
		renderPassEncoder.setVertexBuffer(0, window.testVertexBuffer);
		renderPassEncoder.draw(window.testVertexCount, 1, 0, 0);
