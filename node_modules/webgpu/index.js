...
const filterFragmentShaderGLSL = `#version 450
	...
	void main() {
		...
		outColor = sum * vec4(1, 0, 0, 1);
	}
`;

const {View3D, Vulkan, Bitmap, BlurFilter} = require('./lib');
...
async function init(){
	...
	Vulkan.bindGroupDesc = bindGroupDesc;
	Vulkan.bindGroupLayout = bindGroupLayout;
	...
	Vulkan.filterPipeline = filterPipeline
