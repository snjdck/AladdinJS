...
async function init(){
	...
	let buffer = device.createBuffer({size: 4096, usage: 0});
	...
	let renderPassEncoder = commandEncoder.beginRenderPass({
		colorAttachments:[{
			...
			resolveTarget: null,
			loadValue: 'clear',//or clear by color
	...
	let gpuCanvasContext = canvas.getContext('gpu');
	let swapChain = gpuCanvasContext.configureSwapChain({
		device,
		format: 'rgba8unorm',
		usage: GPUTextureUsage.OUTPUT_ATTACHMENT
	});
	let currentTexture = swapChain.getCurrentTexture();
}
