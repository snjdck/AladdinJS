...
function createMvpBindGroup(){
	const {canvas} = Vulkan;
	const buffer = Vulkan.createBufferMapped(GPUBufferUsage.UNIFORM, new Float32Array([2 / canvas.width, -2 / canvas.height]));
	return Vulkan.createBindGroup('0', {buffer}, Vulkan.getSampler('linear_clamp'));
}
