...
module.exports = async function(){
	...
	const {data:heightData} = decodeBmp(await fetchArrayBuffer('./assets/World1/TerrainHeight.bmp'));
	const mapData = new Uint8Array(await fetchArrayBuffer('./assets/World1/Terrain.map'));
