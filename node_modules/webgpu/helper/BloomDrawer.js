...
const drawBloom = function(){
	const blit1 = blit([[
		{name:'g_sampler', visibility:GPUShaderStage.FRAGMENT, sampler:{}, default:{minFilter:'linear',magFilter:'linear'}},
	...
	const blit2 = blit([[
		{name:'g_sampler', visibility:GPUShaderStage.FRAGMENT, sampler:{}, default:{minFilter:'linear',magFilter:'linear'}},
		{name:'texture' , visibility:GPUShaderStage.FRAGMENT, texture:{}},
		{name:'texture2', visibility:GPUShaderStage.FRAGMENT, texture:{}}
	]], {format: 'rgba16float'}, `
		#include<gauss_blur>
		@fragment
		fn main(@location(0) uvxy: vec4<f32>) -> @location(0) vec4<f32> {
