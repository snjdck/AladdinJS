...
const UniformBufferSlot = function(){
	...
	const activeFn = (materialClass, bindIndex, value, bufferOffset) => Vulkan.renderPassEncoder.setBindGroup(bindIndex, materialClass.createBindGroup(bindIndex, [{buffer:value, size: 0x4000}]), [bufferOffset]);
