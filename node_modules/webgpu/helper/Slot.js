...
function createSlot(maxCountPerSlot, bytePerInstance, valueFn, activeFn, cacheFn){
	...
	return {
		...
		bind: bindIndex => ({add, active: (batchIndex, bufferOffset) => activeFn(bindIndex, cacheFn(batchIndex), bufferOffset * bytePerInstance)})
	};
}
...
function* activeBindGroup(slotList, infoList){
