...
const VertexBufferSlot = function(){
	...
	return (maxCountPerSlot, bytePerInstance, valueFn) => createSlot(maxCountPerSlot, bytePerInstance, valueFn, activeFn, createCache(GPUBufferUsage.VERTEX, maxCountPerSlot * bytePerInstance));
}();
...
const UniformBufferSlot = function(){
	...
	return (bytePerInstance, valueFn) => createSlot(Math.floor(0x4000 / bytePerInstance), bytePerInstance, valueFn, activeFn, createCache(GPUBufferUsage.UNIFORM, 0x8000));
}();
