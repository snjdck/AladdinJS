...
{
	constructor(useDepthBuffer=true, loadValue=[0,0,0,0]){
		super(useDepthBuffer);
		this.renderPassDesc = {colorAttachments: [{loadValue, storeOp: 'store'}]};
		if(useDepthBuffer){
			this.renderPassDesc.depthStencilAttachment = {
				attachment: null,
				depthLoadValue: 1.0,//or load
				depthStoreOp: 'store',//or clear
				stencilLoadValue: 0,//or load
				stencilStoreOp: 'store',//or clear
			};
		}
	}
