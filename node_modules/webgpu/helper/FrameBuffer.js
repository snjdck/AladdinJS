...
class FrameBuffer extends FrameBufferBase
{
	...
	_resize(width, height){
		...
		this.colorBuffer = createTexture(Vulkan.device, width, height, this.depthOrArrayLayers, usage);
...
const addPropColorBuffer = defineMainSubProp('colorBuffer', {
	_colorViewList(){
		...
		for(let i=depthOrArrayLayers-1; i>=0; --i){
			result[i] = colorBuffer.createView({dimension: '2d', baseArrayLayer: i, arrayLayerCount: 1});
		}
		return result;
	}
});
