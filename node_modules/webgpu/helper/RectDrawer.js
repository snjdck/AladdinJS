...
const createDepthDrawFn = (viewDimension, code) => Pipeline.Blit([[
		...
		@fragment{
			...
			let shadow_factor = calc_shadow_${viewDimension}(lightDepthTexture, sampler_depth, pos_in_light_camera, cameraMatrixList.lightCamera.screenMatrix);
			
			return calcLight(normal_in_world, pos_in_light_camera, shadow_factor);
		}
`);
