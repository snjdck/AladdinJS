...
class SlotCache
{
	constructor(bindGroupLayout, maxCount, bytePerInstance, uniformValueFn){
		this.uniformCache = createUniformBufferListCache(bindGroupLayout, (maxCount * 2 - 1) * bytePerInstance, maxCount * bytePerInstance);
...
function createUniformBufferListCache(layout, totalSize, size){
	const bufferList = [];
	const bindGroupList = [];
