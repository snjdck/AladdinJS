...
const TexturePool = function(){
	const queryFn1 = {'undefined':function(v){return v.width >= this.width && v.height >= this.height;}}
	const queryFn2 = {'undefined':function(v){return v.width == this.width && v.height == this.height;}}
