...
const drawFilter2D = function(){
	...
	const [addDrawTask, runDrawTask] = deferBunchDo(renderDrawUnits, frameBuffer => Vulkan.renderPassEncoder.setBindGroup(0, Vulkan.createBindGroup('filter2D', Vulkan.getSampler('linear_clamp'), frameBuffer.getColorView(0))));
