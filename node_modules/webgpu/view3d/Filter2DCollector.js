	...
	return function(root){
		...
		for(const group of list.reverse()){
			...
			for(let i=0, n=group.length; i<n; ++i){
				...
				Vulkan.render2D.tryAdd(filterItem);
				Vulkan.render2D.collect(filterItem, false);
			...
			Vulkan.renderPassEncoder.setBindGroup(0, Vulkan.createBindGroup(Vulkan.bindGroupLayoutDict.bindGroupLayoutFilter2D, [
				Vulkan.sampler_linear_clamp,
				frameBufferA.colorView,
			]));
			for(let i=0, n=group.length; i<n; ++i){
