...
class View3D
{
	...
	render(encoder){
		...
		for(let item of scene2d.camera.drawUnitCollector.bitmap3DList){
			collectWorldMatrixNodes(item.root3d, false, worldMatrixNodes);
			collectBoneStateNodes(item.root3d, false, skeletonNodes);
		}
