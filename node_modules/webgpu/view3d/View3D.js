...
class View3D
{
	...
	render(){
		...
		for(let _ of renderPass3D(commandEncoder, Vulkan.mainColorTexture, Vulkan.mainDepthStencil)){
			scene3d.camera.draw();
		}
		for(let _ of renderPass2D(commandEncoder, Vulkan.mainColorTexture)){
			scene2d.camera.draw();
		}
