...
class View3D
{
	...
	render(device, canvas){
		...
		for(let commandEncoder of CommandEncoder(device, canvas)){
			const colorTexture = commandEncoder.fetchTempTexture(canvas, '2d,bgra8unorm,0x17,1');
			const depthTexture = commandEncoder.fetchTempTexture(canvas, '2d,depth24plus-stencil8,0x17,1');
