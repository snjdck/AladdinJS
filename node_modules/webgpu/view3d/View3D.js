...
class View3D
{
	...
	render(){
		...
		Vulkan.commandEncoders1 = [];
		Vulkan.commandEncoders2 = [];
		...
		renderPass3D(Vulkan.commandEncoder, () => scene3d.camera.draw(), Vulkan.mainColorTexture, Vulkan.mainDepthStencil);
		renderPass2D(Vulkan.commandEncoder, () => scene2d.camera.draw(), Vulkan.mainColorTexture);

		Vulkan.device.queue.submit([
			...Vulkan.commandEncoders2,
			...Vulkan.commandEncoders1,
