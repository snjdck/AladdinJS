...
class ViewportManager
{
	...
	draw(bindGroupIndex=0, useDepthStencilFlag=false){
		...
		Vulkan.renderPassEncoder.setBindGroup(bindGroupIndex, Material2D.createBindGroup(bindGroupIndex, [{buffer:this.buffer}, Vulkan.getSampler(Vulkan.sampler.linear_clamp)]));
