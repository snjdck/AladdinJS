...
class DisplayObject2D extends DisplayObject
{
	constructor(){
		super(Matrix2D);
		addPropTransform(this, new Matrix2D(), this.markWorldMatrixDirty);
	}
...
DisplayObject2D.prototype.getBoundingRect = function(){
	...
	return function(){
		traverseTree.call(this, this, onCollect);
...
const addPropTransform = defineSubMainProp('transform', function(){
	return Matrix2D.compose(this.transform,
		this.scaleX, this.scaleY,
		this.rotation * RADIAN,
		this.x, this.y
	);
}, {x: 0.0, y: 0.0, scaleX: 1.0, scaleY: 1.0, rotation: 0.0});
