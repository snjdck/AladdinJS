	...
	return function(renderPassEncoder, prevCtx){
		...
		if(opaqueList.length > 0){
			for(let commandEncoder of renderPassEncoder.createCommandEncoder()){
				...
				const colorTexture = commandEncoder.fetchTempTexture(textureSize, '2d,bgra8unorm,0x17,1');
				const lightTexture = commandEncoder.fetchTempTexture(textureSize, '2d,bgra8unorm,0x17,1');
				const normalTexture = commandEncoder.fetchTempTexture(textureSize, '2d,rgba16float,0x17,1');
				const emissiveTexture = commandEncoder.fetchTempTexture(textureSize, '2d,rgba16float,0x17,1');
