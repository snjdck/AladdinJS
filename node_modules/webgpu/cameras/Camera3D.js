...
Camera3D.prototype.draw = function(){
	...
	return function(renderPassEncoder, renderPassEncoderDeferred){
		...
		for(let [materialType, entityList] of Array.from(Map.groupBy(this.drawUnitCollector.entityList, groupFn)).sort(sortFn)){
