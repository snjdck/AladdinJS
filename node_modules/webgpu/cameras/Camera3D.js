...
const [addDrawTask, runDrawTask] = deferBunchDo(renderDrawUnits);
const bufferQuery = {usage: GPUBufferUsage.UNIFORM | GPUBufferUsage.COPY_DST, size: 8 * 4 * 4};
...
class Camera3D extends DisplayObject3D
{
	...
	draw(){
		const bufferInfo = fetchBuffer(bufferQuery);
