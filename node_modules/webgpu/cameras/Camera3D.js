...
const {blit} = require('../helper/RectDrawer');
...
const mergeFn = blit([[
	{name:'baseTexture', visibility:GPUShaderStage.FRAGMENT, texture:{}},
	{name:'lightTexture', visibility:GPUShaderStage.FRAGMENT, texture:{}},
	{name:'emissiveTexture', visibility:GPUShaderStage.FRAGMENT, texture:{}},
	{name:'g_sampler', visibility:GPUShaderStage.FRAGMENT, sampler:{}, default:{minFilter:'linear',magFilter:'linear',mipmapFilter:'linear'}},
]], {format: 'bgra8unorm'}, `
