...
void function(){
	...
	const [addDrawTask, runDrawTask] = deferBunchDo(renderDrawUnits, bindGroupIndex => Vulkan.renderPassEncoder.setBindGroup(bindGroupIndex, bufferBindGroup.getBindGroup()));
	...
	Camera3D.draw = function(bindGroupIndex=0){
		Vulkan.requestReset(indexDistributor);
		runDrawTask(bindGroupIndex);
	}
}();
