...
//const createDictGetter = (newFn, dict={}) => createListGetter(newFn, dict);
...
function createFetch(loadFn){
	...
	return (key, promiseFlag=true) => {
		...
		return promiseFlag ? waitList ? new Promise((resolve, reject) => waitList.push([resolve, reject])) : Promise.resolve(value) : value;
	};
}
