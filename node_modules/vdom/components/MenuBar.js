...
const MenuBar = createElement(function(tag, end, {port, board, mode, onClick}){
	...
	tag('ul', {className:'menu-bar'/*,style:{'--menu-z-index':71}*/, onMouseDown(evt){
		...
		tag('li', {style:{width:'100%'}}), end('li')
		tag('li'), tag('a', {'data-title':'串口', href:'#choosePort'}), tag`${port}`, end('a'), end('li')
		tag('li'), tag('a', {'data-title':'模式', href:'#chooseMode'}), tag`${mode}`, end('a'), end('li')
