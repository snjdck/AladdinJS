...
const op = {
	...
	call: i => [0x10, ...gen_vuint(i)],//	[t∗1]→[t∗2]	
	...
	simd:{
		...
		i8x16:{
			splat: [0xFD, 0x04],
			extract_lane_s: i => [0xFD, 0x05, i],
			extract_lane_u: i => [0xFD, 0x06, i],
			replace_lane: i => [0xFD, 0x07, i],
			eq: [0xFD, 0x18],
			ne: [0xFD, 0x19],
			lt_s: [0xFD, 0x1a],
			lt_u: [0xFD, 0x1b],
			...
			shr_u: [0xFD, 0x56],
			add: [0xFD, 0x57],
			add_saturate_s: [0xFD, 0x58],
			add_saturate_u: [0xFD, 0x59],
			sub: [0xFD, 0x5a],
			sub_saturate_s: [0xFD, 0x5b],
			sub_saturate_u: [0xFD, 0x5c],
			narrow_i16x8_s: [0xFD, 0xc6],
			narrow_i16x8_u: [0xFD, 0xc7],
		},
		i16x8:{
			splat: [0xFD, 0x08],
			extract_lane_s: i => [0xFD, 0x09, i],
			extract_lane_u: i => [0xFD, 0x0A, i],
			replace_lane: i => [0xFD, 0x0B, i],
			eq: [0xFD, 0x22],
			ne: [0xFD, 0x23],
			lt_s: [0xFD, 0x24],
			lt_u: [0xFD, 0x25],
			...
			shr_u: [0xFD, 0x67],
			add: [0xFD, 0x68],
			add_saturate_s: [0xFD, 0x69],
			add_saturate_u: [0xFD, 0x6a],
			sub: [0xFD, 0x6b],
			sub_saturate_s: [0xFD, 0x6c],
			sub_saturate_u: [0xFD, 0x6d],
			mul: [0xFD, 0x6e],
			narrow_i32x4_s: [0xFD, 0xc8],
			narrow_i32x4_u: [0xFD, 0xc9],
			widen_low_i8x16_s: [0xFD, 0xca],
			widen_high_i8x16_s: [0xFD, 0xcb],
			widen_low_i8x16_u: [0xFD, 0xcc],
			widen_high_i8x16_u: [0xFD, 0xcd],
		},
		i32x4:{
			splat: [0xFD, 0x0C],
			extract_lane: i => [0xFD, 0x0D, i],
			replace_lane: i => [0xFD, 0x0E, i],
			eq: [0xFD, 0x2c],
			ne: [0xFD, 0x2d],
			lt_s: [0xFD, 0x2e],
			lt_u: [0xFD, 0x2f],
			...
			sub: [0xFD, 0x7c],
			mul: [0xFD, 0x7f],
			trunc_sat_f32x4_s: [0xFD, 0xab],
			trunc_sat_f32x4_u: [0xFD, 0xac],
			widen_low_i16x8_s: [0xFD, 0xce],
			widen_high_i16x8_s: [0xFD, 0xcf],
			widen_low_i16x8_u: [0xFD, 0xd0],
			widen_high_i16x8_u: [0xFD, 0xd1],
		},
		i64x2:{
			splat: [0xFD, 0x0F],
			extract_lane: i => [0xFD, 0x10, i],
			replace_lane: i => [0xFD, 0x11, i],
			neg: [0xFD, 0x84],
			shl: [0xFD, 0x87],
			shr_s: [0xFD, 0x88],
			shr_u: [0xFD, 0x89],
			...
			sub: [0xFD, 0x8d],
			mul: [0xFD, 0x90],
			trunc_sat_f64x2_s: [0xFD, 0xad],
			trunc_sat_f64x2_u: [0xFD, 0xae],
		},
		f32x4:{
			splat: [0xFD, 0x12],
			extract_lane: i => [0xFD, 0x13, i],
			replace_lane: i => [0xFD, 0x14, i],
			eq: [0xFD, 0x40],
			ne: [0xFD, 0x41],
			lt: [0xFD, 0x42],
			gt: [0xFD, 0x43],
			...
			min: [0xFD, 0x9e],
			max: [0xFD, 0x9f],
			convert_i32x4_s: [0xFD, 0xaf],
			convert_i32x4_u: [0xFD, 0xb0],
		},
		f64x2:{
			splat: [0xFD, 0x15],
			extract_lane: i => [0xFD, 0x16, i],
			replace_lane: i => [0xFD, 0x17, i],
			eq: [0xFD, 0x46],
			ne: [0xFD, 0x47],
			lt: [0xFD, 0x48],
			gt: [0xFD, 0x49],
			...
			min: [0xFD, 0xa9],
			max: [0xFD, 0xaa],
			convert_i64x2_s: [0xFD, 0xb1],
			convert_i64x2_u: [0xFD, 0xb2],
		},
	}
};
