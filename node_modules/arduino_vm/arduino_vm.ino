...
void handleInvoke(byte fnID, Value *args){
	...
	case FN_CAST_FLOAT_TO_INT:
		...
		break;
	case FN_GT:
		args[0].i32 = args[0].i32 > args[1].i32;
		break;
	case FN_LT:
		args[0].i32 = args[0].i32 < args[1].i32;
		break;
...
//============================
		...
		OP_JUMP, 3, 0, 0, 0,
			...
			OP_PUSH, 3, 0, 0, 0,//push 3 (pin)
			OP_INVOKE, 1, 0, 1, 0,//invoke fn 1 with 1 args ret 0 args

		OP_CALL, FN_DECREASE, 0, 1, 1,
		OP_CALL, FN_DUPLICATE, 0, 1, 2,
		OP_CALL, FN_IS_NOT_NEGATIVE, 0, 1, 1,
		OP_JUMP_IF, 0xfb, 0xff, 0xff, 0xff,
		OP_CALL, FN_POP, 0, 1, 0,


		//--------------------------------
		OP_PUSH, 15, 0, 0, 0,//push A1, port_D

		OP_PUSH, 21, 0, 0, 0,//push A7
		OP_CALL, FN_READ_ANALOG, 0, 1, 1,
		OP_PUSH, 100, 0, 0, 0,//push 50
		OP_CALL, FN_GT, 0, 2, 1,

		OP_CALL, FN_WRITE_DIGITAL, 0, 2, 0,


		OP_PUSH, 0, 4, 0, 0,//push 1024
		OP_CALL, 1, 0, 1, 0,//call 1 with 1 args ret 0 args(delay)
		OP_JUMP, 0xf8, 0xff, 0xff, 0xff,
