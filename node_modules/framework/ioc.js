...
class Injector
{
	...
	constructor(parent=null){
		this.parent = parent;
		this.ruleDict = Object.create(null);
	}
	...
	getInstance(type, id=null){
		console.log("getInstance", type, id);
	...
	injectInto(target){
		...
		let callback = target[Injector.Tag];
