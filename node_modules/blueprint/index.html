...
<head>
	...
	<template id="my-element">
		...
		<div class="card">
			<div class="title"><slot name="title">NEED TITLE</slot></div>
			<div class="close">×</div>
			<div class="body">
...
<body>
	...
	<svg height="100%" width="100%" id="svgContainer3" class="grid-background">
		<!--<defs>
	...
	<div>
			<my-card style="left:300px;top:400px;" >
			...
			<my-card style="left:600px;top:400px;" >
				<span slot="title">Start</span>
				<div slot="input" data-connected="0" data-statement="1">in</div>
				<div slot="input" data-connected="1" data-statement="1">in</div>
				<div slot="input" data-connected="0" data-statement="0">in</div>
			...
			<my-card style="left:900px;top:400px;" >
				<span slot="title">Start</span>
				<div slot="input" data-connected="0" data-statement="1">in</div>
				<div slot="input" data-connected="1" data-statement="1">in</div>
				<div slot="input" data-connected="0" data-statement="0">in</div>
		...
		<svg id="svgContainer" style="pointer-events: none;"></svg>
		<div>
