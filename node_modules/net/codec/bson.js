...
const encode = function(){
	...
	function calcType(value){
		...
		if(value instanceof Int64)return INT64;
...
const decode = function(){
	...
	function readData(buffer, type){
		switch(type){
			...
			case INT64:		return new Int64(buffer.readBytes(8));
...
class Int64
{
	...
	toJSON(){
		let ba = this.value;
		return ba.readUInt32LE(0) + ba.readInt32LE(4) * 0x100000000;
	}
}
...
class ObjectID
{
	...
	toJSON(){
		return Array.prototype.map.call(this.value, v => v.toString(16).padStart(2, '0')).join('_');
	}
}
