...
const encode = function(){
	...
	function writeDoc(value){
		...
		return [castInt32(calcTotalSize(payload)+5), payload, Buffer.alloc(1)];
	}
	function writeData(key, value){
		...
		switch(type){
			...
			case STRING:
				...
				buffer = [castInt32(buffer.length+1), buffer, Buffer.alloc(1)];
				break;
			case DOCUMENT:
			...
			case ARRAY:
				...
				break;
			case BINARY:
				buffer = [castInt32(value.length), Buffer.alloc(1), value];
				break;
			case BOOLEAN:
